...
function generateScripts() {
    ...
    $scripts .= '<!-- Panel de Personalización de Colores -->' . "\n";
    $scripts .= '<div class="color-panel-toggle" id="colorPanelToggle">' . "\n";
    $scripts .= '    <i class="fas fa-palette"></i>' . "\n";
    $scripts .= '</div>' . "\n";
    $scripts .= '' . "\n";
    $scripts .= '<div class="color-panel-overlay" id="colorPanelOverlay"></div>' . "\n";
    $scripts .= '' . "\n";
    $scripts .= '<div class="color-panel-sidebar" id="colorPanelSidebar">' . "\n";
    $scripts .= '    <div class="color-panel-header">' . "\n";
    $scripts .= '        <h3><i class="fas fa-magic me-2"></i>Personalizar Colores</h3>' . "\n";
    $scripts .= '    </div>' . "\n";
    $scripts .= '    <div class="color-panel-content">' . "\n";
    $scripts .= '        <div class="color-theme active" data-theme="galactic-blue">' . "\n";
    $scripts .= '            <h4>Galáctico Azul</h4>' . "\n";
    $scripts .= '            <div class="color-preview">' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #00bfff;"></div>' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #8a2be2;"></div>' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #16213e;"></div>' . "\n";
    $scripts .= '            </div>' . "\n";
    $scripts .= '            <p>El clásico azul neón con morado eléctrico</p>' . "\n";
    $scripts .= '        </div>' . "\n";
    $scripts .= '        ' . "\n";
    $scripts .= '        <div class="color-theme" data-theme="cyber-green">' . "\n";
    $scripts .= '            <h4>Cíber Verde</h4>' . "\n";
    $scripts .= '            <div class="color-preview">' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #00ff00;"></div>' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #32cd32;"></div>' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #006400;"></div>' . "\n";
    $scripts .= '            </div>' . "\n";
    $scripts .= '            <p>Verde neón para una vibra más hacker</p>' . "\n";
    $scripts .= '        </div>' . "\n";
    $scripts .= '        ' . "\n";
    $scripts .= '        <div class="color-theme" data-theme="fire-red">' . "\n";
    $scripts .= '            <h4>Fuego Rojo</h4>' . "\n";
    $scripts .= '            <div class="color-preview">' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #ff0000;"></div>' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #ff4500;"></div>' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #8b0000;"></div>' . "\n";
    $scripts .= '            </div>' . "\n";
    $scripts .= '            <p>Rojo intenso para energía máxima</p>' . "\n";
    $scripts .= '        </div>' . "\n";
    $scripts .= '        ' . "\n";
    $scripts .= '        <div class="color-theme" data-theme="golden-sun">' . "\n";
    $scripts .= '            <h4>Sol Dorado</h4>' . "\n";
    $scripts .= '            <div class="color-preview">' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #ffd700;"></div>' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #ffa500;"></div>' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #daa520;"></div>' . "\n";
    $scripts .= '            </div>' . "\n";
    $scripts .= '            <p>Dorado y naranja para elegancia cósmica</p>' . "\n";
    $scripts .= '        </div>' . "\n";
    $scripts .= '        ' . "\n";
    $scripts .= '        <div class="color-theme" data-theme="neon-pink">' . "\n";
    $scripts .= '            <h4>Neón Rosa</h4>' . "\n";
    $scripts .= '            <div class="color-preview">' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #ff69b4;"></div>' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #ff1493;"></div>' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #c71585;"></div>' . "\n";
    $scripts .= '            </div>' . "\n";
    $scripts .= '            <p>Rosa vibrante para un toque futurista</p>' . "\n";
    $scripts .= '        </div>' . "\n";
    $scripts .= '        ' . "\n";
    $scripts .= '        <div class="color-theme" data-theme="ice-blue">' . "\n";
    $scripts .= '            <h4>Hielo Azul</h4>' . "\n";
    $scripts .= '            <div class="color-preview">' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #00ffff;"></div>' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #87ceeb;"></div>' . "\n";
    $scripts .= '                <div class="color-swatch" style="background: #4682b4;"></div>' . "\n";
    $scripts .= '            </div>' . "\n";
    $scripts .= '            <p>Azul cian para una sensación glacial</p>' . "\n";
    $scripts .= '        </div>' . "\n";
    $scripts .= '    </div>' . "\n";
    $scripts .= '</div>' . "\n";
